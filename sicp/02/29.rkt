...
;;
;; b. Using your selectors, define a
;; procedure total-weight that returns the total weight of a
;; mobile.
;;
;; c. A mobile is said to be balanced if the torque
;; applied by its top-left branch is equal to that applied by its
;; top-right branch (that is, if the length of the left rod
;; multiplied by the weight hanging from that rod is equal to the
