...
;; essentially nothing more than calls to the prim- itive
;; procedures + , - , etc. It was not possible to use the prim-
...
;; tem, which they use internally. Primitive predicates such as
...
;; cept that ordinary numbers should be represented simply as
...
;; the operations types mapping table
...
;; the generic arithmemtic procedures for the client code
(define (add x y) (apply-generic 'add x y))
(define (sub x y) (apply-generic 'sub x y))
(define (mul x y) (apply-generic 'mul x y))
(define (div x y) (apply-generic 'div x y))

;; ordinary scheme number package
...
;; ordinary scheme number constructor
