...
;; that applying T over and over again n times, starting with 1
;; and 0, produces the pair Fib(n + 1) and Fib(n). In other words,
...
;; we apply such a transformation T pq twice, the effect is the
;; same as using a single transformation T p'q' of the same form,
...
;; Appling T_{p,q} twice:
;; a = b(pq + pq + qq) + a(pq + pq + qq) + a(qq + pp)
;; a = aq' + aq' + ap'
;;
