...
;; observation that $(b \frac{n}{2}) 2 = (b 2 ) \frac{n}{2}$,
;; keep, along with the exponent n and the base b, an additional
;; state variable a, and define the state transformation in such
;; a way that the product $a b^{n}$ is unchanged from state to
;; state. At the beginning of the process a is taken to be 1, and
